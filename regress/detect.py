...
class DetectSFSROpen(regress.Test):
    def Setup(self):
        ...
        # Packet 1
        payload = TCP(sport=555, dport=80, seq=10000, flags=dnet.TH_SYN | dnet.TH_RST)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
        ...
        # Packet 2
        payload = TCP(sport=556, dport=80, seq=10000, flags=dnet.TH_SYN | dnet.TH_FIN)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5625,
...
class DetectSAAROpen(regress.Test):
    def Setup(self):
        ...
        # Packet 1
        payload = TCP(sport=555, dport=80, seq=10000, flags=dnet.TH_SYN | dnet.TH_ACK)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5624,
        ...
        # Packet 2
        payload = TCP(sport=556, dport=80, seq=10000, flags=dnet.TH_ACK | dnet.TH_RST)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5625,
...
class DetectSAARClose(regress.Test):
    def Setup(self):
        ...
        # Packet 1
        payload = TCP(sport=555, dport=79, seq=10000, flags=dnet.TH_SYN | dnet.TH_ACK)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5624,
        ...
        # Packet 2
        payload = TCP(sport=556, dport=79, seq=10000, flags=dnet.TH_ACK | dnet.TH_RST)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5625,
...
class DetectSFSRClose(regress.Test):
    def Setup(self):
        ...
        # Packet 1
        payload = TCP(sport=555, dport=79, seq=10000, flags=dnet.TH_SYN | dnet.TH_RST)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5624,
        ...
        # Packet 2
        payload = TCP(sport=556, dport=79, seq=10000, flags=dnet.TH_SYN | dnet.TH_FIN)
        ip = IP(
            src=dnet.ip_aton("192.0.2.1"),
            dst=dnet.ip_aton("192.18.0.10"),
            id=5625,
